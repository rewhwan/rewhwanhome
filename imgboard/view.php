...
include $_SERVER['DOCUMENT_ROOT'] . "/rewhwanhome/imgboard/lib/imgboard_func.php";
...
if (isset($_GET["num"]) && !empty($_GET["num"])) {
    ...
    $sql = "UPDATE `imgboard` SET `hit`=$hit WHERE `num`=$q_num;";
    $result = mysqli_query($con, $sql);
    if (!$result) {
        die('Error: ' . mysqli_error($con));
    }

    $sql = "SELECT * from `imgboard` where num ='$q_num';";
    $result = mysqli_query($con, $sql);
    if (!$result) {
        die('Error: ' . mysqli_error($con));
    }
            ...
            <div id="content">
                <div id="col2">
                    ...
                    <div id="ripple">
                        ...
                        <div id="ripple2">
                            <?php
                            $sql = "select * from `imgboard_ripple` where parent='$q_num' ";
                            ...
                            while ($ripple_row = mysqli_fetch_array($ripple_result)) {
                                ...
                                <div id="ripple_title">
                                    <ul>
                                        ...
                                        <li id="mdi_del">
                                            <?php
                                            $message = imgboard_ripple_delete($ripple_id, $ripple_num, 'dml_board.php', $page, $hit, $q_num);
                                            echo $message;
                                            ?>
                                        </li>
                                    </ul>
