<?php
    ...
    create_table($con, 'answerboard');//자유게시판테이블생성
    create_table($con, 'answerboard_ripple');//자유게시판덧글테이블생성
    ...
    if (isset($_GET["mode"]) && $_GET["mode"] == "search") {
        ...
        $sql = "SELECT * from `answerboard` where $find like '%$q_search%' order by num desc;";
    } else {
        $sql = "SELECT * from `answerboard` order by num desc";
    }
