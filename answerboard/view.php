...
include $_SERVER['DOCUMENT_ROOT'] . "/rewhwanhome/answerboard/lib/answerboard_func.php";
...
if (isset($_GET["num"]) && !empty($_GET["num"])) {
    ...
    $sql = "UPDATE `answerboard` SET `hit`=$hit WHERE `num`=$q_num;";
            ...
            <div id="content">
                <div id="col2">
                    ...
                    <div id="ripple">
                        ...
                        <div id="ripple2">
                            <?php
                            $sql = "select * from `answerboard_ripple` where parent='$q_num' ";
                            ...
                            while ($ripple_row = mysqli_fetch_array($ripple_result)) {
                                ...
                                <div id="ripple_title">
                                    <ul>
                                        ...
                                        <li id="mdi_del">
                                            <?php
                                            $message = answerboard_ripple_delete($ripple_id, $ripple_num, 'dml_board.php', $page, $hit, $q_num);
                                            echo $message;
                                            ?>
                                        </li>
                                    </ul>
